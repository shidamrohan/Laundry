          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const Text('Order #VOSHIFY1042', style: TextStyle(color: _textPrimary, fontSize: 18, fontWeight: FontWeight.bold)),
          ...
          Container(
            ...
            child: Row(
              children: const [
                ...
                SizedBox(width: 8),
                Text('Paid via VOSHIFY Wallet + UPI', style: TextStyle(color: _textSecondary, fontSize: 12, fontWeight: FontWeight.bold)),
              ],
            ),
          ),
        ],
