      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () => showBillDetailsBottomSheet(context),
              child: Row(
                children: const [
                  Text(
                    'View bill',
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: const DecorationImage(
                      image: NetworkImage(
                        'https://lh3.googleusercontent.com/aida-public/AB6AXuBE_J33ca1hgintlS_nUQhgKIaeymKeq5ucc0xbR9fyUlMRt6npn_ilKmDdcbWhvQXsis-BQdQ47duP2UE8-zJMn5Ti-nshWs7BRuQU3XADzZbraOQsxgkIJWkmCVA3ksfEHyodh4VIzAW1i3vZ6q0oP0PSBTvvCvgW01ycSAw8oKDNDuzExWGjXo3E0RmjCvDvAdfMfmeKk9s6pa5qQXovlqPkWe-tD1OdkYk-0cTqtiUGxTAa7ga9i9VV6I4k_8CT64QuBsYsaqdE',
                      ),
                      fit: BoxFit.contain,
                    ),
                  ),
        ...
        child: Column(
          ...
          children: [
            ...
            _buildPaymentOption(
              ...
              title: 'PhonePe',
              imageUrl:
                  'https://lh3.googleusercontent.com/aida-public/AB6AXuBHOlIeHGSqgo9CKHP_7jDbGrEQmJih79W6nhlTKDBX3Vb0gb-dW_vmsgVnCpFEZnizm4lN055phsgp9h4NXjlIcqyBHF_HluAOAipFDTucVTJimRrcpfpmm7klfRvOGGNcIv4WTR8JZgVUkF2zUNBIBMwB_rWfsBpnaV7e4Cf8F4mRYzyDsWdsyYO0RmbvD85SbMNoAm0Q_zZ9QykztCsC7471St04rBHY_2jvYqo-4d5zBznmiuXcqpHTwu-BmNa4ifL2vM-npEkY',
            ),
            const Divider(height: 1, color: Color(0xFFE2E8E9)),
            _buildPaymentOption(
              id: 'paytm',
              title: 'Paytm',
              imageUrl:
                  'https://lh3.googleusercontent.com/aida-public/AB6AXuAskMhGo4tZ2HIW4ANolyHObUZ_HXIp6iCCg026f3l1h5gYQPk6yUmWTw_M9X8NJPG9_Y2Ce4cstplwaN7SP0rlwzEeDhWziOuaVCxIr11kTq74q7M6lxX_VSgjZQ2iMfnkAJGjJ4aEaFtndyMMSul8-RvRRXKpILHE9IR4MgGgd1YWnPD4ay9In_GJw4ZbG1BK4XeAQK-oo859ouJnMkRDXB5fxCRy1fvyvkGB3xf2G9hFuPRifdnq57a5sJvSbcon61z1ttTYMKZL',
            ),
            const Divider(height: 1, color: Color(0xFFE2E8E9)),
            _buildActionOption(
              icon: Icons.add,
        ...
        child: Column(
          ...
          children: [
            ...
            _buildPaymentOption(
              ...
              imageUrl:
                  'https://lh3.googleusercontent.com/aida-public/AB6AXuDSyb5VDwToXFNTznILPQ6yJx5bQvxOv_bdgFJwIwFpcrUn7oRkP1JMGmtRvZIXjdu2DTE7If2623_jne5ZGb7CErf8E45i17wM-IrvXvhw85s6ntYU98_sfiUvrRHzn0ANm2bdqnyT94vV0VgJhr_iUt2glddb5wRm63P4D6I9fDHyvYcjxIRVzw12HHALYLz5jMnc_n0c-My9ydo6RHZop0bn3_oIV38fM-V6BGixdVk5Di2OK4JqnUx_hFkMN2BXq8HBdeROUH9b',
            ),
            const Divider(height: 1, color: Color(0xFFE2E8E9)),
            _buildActionOption(
  ...
  Widget _buildTrustBadges() {
    return Column(
      children: const [
        ...
        SizedBox(height: 8),
        Text(
          'PCI-DSS compliant systems with 256-bit encryption',
          style: TextStyle(color: Color(0xFF0F172A), fontSize: 10),
        ),
      ],
    );
  }
  ...
  Widget _buildRadio(bool isSelected) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isSelected ? const Color(0xFF0EA5A4) : const Color(0xFFE2E8E9),
          width: 2,
        ),
      ),
      child: isSelected
